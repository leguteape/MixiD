...
namespace ImGuiKnobs {
    namespace detail {
        ...
        struct knob {
            ...
            void draw_arc(float radius, float size, float start_angle, float end_angle, ImVec4 color) {
                auto track_radius = radius * this->radius;
                auto track_size = size * this->radius * 0.5f + 0.0001f;

                detail::draw_arc(center, track_radius, start_angle, end_angle, track_size, color);
            }
        };
    ...
    bool BaseKnob(
        ...
        switch (variant) {
            ...
            case ImGuiKnobVariant_Wiper: {
                ...
                //knob.draw_circle(0.7f, detail::GetSecondaryColorSet(), true, 32);
                knob.draw_arc(0.82f, 0.41f, 0, 360, ImVec4(0.05,0.05,0.05,0.8));
                ...
                knob.draw_tick(0.2f, 0.60f, 0.10f, knob.angle, detail::GetPrimaryColorSet());
